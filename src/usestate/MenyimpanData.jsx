...
function MenyimpanData() {
   ...
   return (
      <div className='flex flex-col items-center justify-center h-screen gap-5'>
         <h1 className='font-mono font-bold uppercase'><span className="text-blue-400">{'<'}</span> Real Num Counta <span className="text-blue-400">{'>'}</span></h1>
         ...
         <button onClick={() => setAngka(0)} className='flex items-center gap-1 px-2 py-1 text-xs uppercase border cursor-pointer hover:text-white hover:border-blue-400 hover:bg-blue-400 border-zinc-400'><ArrowCounterClockwiseIcon size={12}/> Reset</button>
      </div>
   )
}
